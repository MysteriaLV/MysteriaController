...
{
  Serial.begin(115200);
  Serial.println("Serial ModBus Slave POWER_CONSOLE:1 for lua/Aliens.lua");
  ...
  */
  ...
  holdingRegs[ACTIONS] = 0;
  holdingRegs[CONNECT] = 0;
  holdingRegs[POWER_ON] = 0;
  // Sample calls
  // buttonStatus_setup(CONNECT, <buttonPin>);
}
...
void loop()
{
  ...
  // holdingRegs[CONNECT] = 1;
  // holdingRegs[POWER_ON] = 1;
  

  // Sample calls
  // buttonStatus(CONNECT, <buttonPin>);
}